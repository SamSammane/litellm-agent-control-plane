...
sse_tmp="$(mktemp -t hermes-smoke-sse.XXXXXX)"
...
{
  "events": [
    { "type": "user.message", "content": [ { "type": "text", "text": "Say hello from Hermes Agent in one short sentence." } ] }
  ]
}
JSON
)")
